...
write.csv(colMeans(daphniakmers_normalized[Pop_indexes, common.kmer.indexes]), file="~/Documents/FirstRotation-Andy/SubmissionScripts/Metals/population_kmermeans.csv") 
...
#write.table(tableS1, file="~/Documents/FirstRotation-Andy/SuppTables/tableS1.txt" , quote=F, col.names=T, row.names=F, sep="\t")
```
## Figure 1
```{r}
...
Use script : `dmel_compare.py` to get intersecting kmers between D. melanogaster and D. pulex.  

Search for and count common motifs with `motif_search.py`.  
